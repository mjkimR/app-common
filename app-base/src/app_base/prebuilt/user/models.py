...
class User(Base, UUIDMixin, TimestampMixin):
    ...
    lastname: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, comment="The user's last name.")
    ...
    extra: Mapped[Optional[dict]] = mapped_column(
        JSON, nullable=True, comment="Additional user metadata in JSON format."
    )
