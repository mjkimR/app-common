...
from app_base.core.middlewares.timeout_middleware import TimeoutMiddleware, add_middleware
...
def test_timeout_logs_error_on_timeout():
    ...
    client = TestClient(app, raise_server_exceptions=False)
    with patch("app_base.core.middlewares.timeout_middleware.logger") as mock_logger:
        client.get("/slow")
