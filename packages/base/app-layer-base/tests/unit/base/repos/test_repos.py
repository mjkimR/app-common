"""Unit app_tests for app_layer_base.base.repos.base module."""
...
class TestBaseRepositorySelect:
    ...
    def test_select_with_single_where_condition(self, mock_repository):
        ...
        from tests.support.mock_models import MockModel
...
class TestBaseRepositoryUpdate:
    ...
    async def test_update_by_pk_with_schema(self, mock_repository, mock_async_session, mock_model, sample_uuid):
        ...
        from tests.support.mock_models import MockUpdateSchema
...
class TestBaseRepositoryDelete:
    ...
    async def test_soft_delete_enabled_without_column_raises_at_init(self):
        ...
        from tests.support.mock_models import MockCreateSchema, MockModel, MockUpdateSchema
