...
from app_prebuilt_google_auth.api import BROWSER_COOKIE, router
from app_prebuilt_google_auth.config import GoogleAuthSettings, get_google_auth_settings
from app_prebuilt_google_auth.models import GoogleLoginFlow
from app_prebuilt_google_auth.provider import GoogleIdentity, GoogleProvider
from app_prebuilt_user.api import v1_users_router
from app_prebuilt_user.config import AuthSettings, get_auth_settings
from app_prebuilt_user.identities import ExternalIdentity
...
async def test_concurrent_callback_is_consumed_once(login_http, is_postgres):
    ...
    from app_prebuilt_google_auth.repos import GoogleAuthRepository
    from app_prebuilt_google_auth.services import GoogleAuthService
    from app_prebuilt_google_auth.usecases import GoogleAuthUseCase
