...
class TestAIClient:
    def test_initializes_litellm_router(self, mocker, raw_config, mock_router, tmp_path):
        mock_load = mocker.patch(
            "app_ai_catalog.models.client.ConfigLoader.load_yaml_with_env", return_value=raw_config
        )
    ...
    def test_completion_delegates_to_router_with_resolved_name(self, mocker, raw_config, mock_router, tmp_path):
        mocker.patch("app_ai_catalog.models.client.ConfigLoader.load_yaml_with_env", return_value=raw_config)
