...
from app_event_broker.lifespan import lifespan_event_broker
...
async def test_lifespan_event_broker_initializes_and_cleans_up():
    ...
    with (
        patch(
            "app_event_broker.lifespan.get_event_broker_settings",
            return_value=mock_settings,
        ) as mock_get_settings,
        patch(
            "app_event_broker.lifespan.setup_event_broker",
        ) as mock_setup,
        patch(
            "app_event_broker.lifespan.close_event_broker",
