...
from app_file_storage.instance import (
...
def reset_global_file_storage_client():
    ...
    import app_file_storage.instance as file_storage_instance
...
async def test_setup_storage_client_initializes_client(mock_client):
    ...
    with patch(
        "app_file_storage.instance.FileStorageFactory.create_client",
