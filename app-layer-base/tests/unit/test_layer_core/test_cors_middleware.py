...
from app_layer_base.core.middlewares.cors_middleware import add_middleware
...
def test_add_middleware_specific_origins():
    app = FastAPI()
    with patch("app_layer_base.core.middlewares.cors_middleware.get_app_settings") as mock_settings:
